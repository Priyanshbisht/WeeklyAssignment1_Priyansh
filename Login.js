...
const LoginScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Image source={require('./Rectangle 7.png')} style={styles.rightIcon}></Image>
      ...
      <View style={styles.passwordIconContainer}>
       ...
       <Text style={{textAlign:"center"}}>or connect with </Text>
        ...
        <Image source={require('./instagram 1.png')} style={styles.icon}></Image>
       ...
       <View style={styles.bottomIconContainer}>
        <Image source={require('./image 11.png')} style={styles.bottomIcon}></Image>
      </View>
       <View style={styles.overlapIconContainer}>
          <Image source={require('./Subtract.png')} style={styles.overlapIcon}></Image>
        </View>
        <View style={styles.overlapIconContainer2}>
          <Image source={require('./Frame 450.png')} style={styles.overlapIcon}></Image>
